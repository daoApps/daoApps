...
<template>
  <MainLayout>
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-6">
        <h1
          class="text-2xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600"
        >
          设置中心
        </h1>
      ...
      <div class="flex flex-col lg:flex-row gap-6">
        ...
        <aside class="lg:w-64 flex-shrink-0">
          <nav
            class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm lg:sticky lg:top-4"
          >
            <ul class="py-2">
        ...
        <main class="flex-1 min-w-0">
          <div
            class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8 min-h-[500px]"
          >
            <!-- 个人资料 -->
            ...
            <div v-if="activeSection === 'about'" class="space-y-8">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div
                  class="p-5 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl"
                >
                ...
                <div
                  class="p-5 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl"
                >
                ...
                <div>
                  ...
                  <ul class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                    <li class="flex items-start gap-2">
                      <span class="text-green-500 mt-0.5">✓</span> 全面重构为 Vue3 + TypeScript +
                      Composition API
                    </li>
                    <li class="flex items-start gap-2">
                    ...
                    <li class="flex items-start gap-2">
                      <span class="text-green-500 mt-0.5">✓</span> 全新设置中心界面设计
                    </li>
                    <li class="flex items-start gap-2">
                      <span class="text-green-500 mt-0.5">✓</span> 优化性能和用户体验
                    </li>
                    <li class="flex items-start gap-2">
                      <span class="text-green-500 mt-0.5">✓</span> 修复已知问题并提升稳定性
                    </li>
                  </ul>
                </div>
              </div>
              ...
              >
                <a href="#" class="text-sm text-indigo-500 hover:text-indigo-600 transition-colors"
                  >查看完整更新日志 →</a
                >
