...
const sendMessage = () => {
  ...
  const msg: Message = {
    ...
    toAgentName: selectedAgentId.value
      ? presetAgents.find((a) => a.id === selectedAgentId.value)?.name
      : undefined,
    type: 'request',
  ...
  >
    ...
    <div ref="messagesContainer" class="flex-1 overflow-y-auto p-4 space-y-4">
      ...
      <div v-for="group in groupedMessages" :key="group.date">
        ...
        <div class="relative flex items-center justify-center my-4">
          ...
          <span
            class="relative px-3 text-xs font-medium text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800"
          >
            {{ group.date }}
          </span>
        </div>
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <!-- Actions on Hover -->
            <div
              class="mt-2 pt-2 border-t border-current/10 pl-8 opacity-0 group-hover:opacity-100 transition-opacity"
            >
    ...
    <div class="border-t border-gray-200 dark:border-gray-700 p-4">
      ...
      <div class="flex items-center justify-between mt-2 text-xs text-gray-500 dark:text-gray-400">
        ...
        <button class="hover:text-red-500 transition-colors" @click="clearMessages">
          清空消息
        </button>
      </div>
    </div>
