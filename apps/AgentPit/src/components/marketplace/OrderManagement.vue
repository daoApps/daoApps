    ...
    <div v-else class="space-y-4">
      ...
      >
        <div class="px-6 py-4">
          ...
          <div
            class="flex items-center justify-between mt-4 pt-3 border-t border-gray-100 dark:border-gray-700"
          >
            <button
          ...
          >
            <div>
              <h5
                class="text-sm font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-1.5"
              >
                <svg
            ...
            <div v-if="order.trackingNumber">
              ...
              >
                ...
                >
                  ...
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M13 16V4a1 1 0 00-1-1H4a1 1 0 00-1 1v16a1 1 0 001 1h2m8-1H9m4-1h2m0 0h2m-4 0v-4m0 4l-4-4"
                  />
                </svg>
                物流信息
              </h5>
              ...
              <div
                v-if="order.logisticsInfo && order.logisticsInfo.length > 0"
                class="relative pl-4 border-l-2 border-gray-200 dark:border-gray-600 space-y-3"
              >
                <div v-for="(step, idx) in order.logisticsInfo" :key="idx" class="relative">
                  <div
                    :class="[
            ...
            <div class="flex flex-wrap gap-2 pt-2">
              ...
              <template v-if="order.status === 'completed'">
                ...
                <button
                  class="px-4 py-2 border border-primary-500 text-primary-500 rounded-lg text-sm font-medium hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-colors"
                >
                  再次购买
                </button>
                <button
