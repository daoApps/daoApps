...
<template>
  <header class="fixed top-0 left-0 right-0 z-50 h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
    <div class="h-full px-4 flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <RouterLink to="/" class="flex items-center gap-2 group">
          <div class="w-8 h-8 bg-gradient-to-br from-primary-500 to-primary-700 rounded-lg flex items-center justify-center text-white font-bold text-sm shadow-md group-hover:shadow-lg transition-shadow">
            AP
          </div>
          <div class="hidden sm:block">
            <h1 class="text-xl font-bold text-gray-900 dark:text-white leading-tight">{{ logoText }}</h1>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="relative">
          ...
          >
            ...
            <span class="hidden md:block text-sm font-medium text-gray-700 dark:text-gray-300">用户</span>
          ...
          <Teleport to="body">
            <Transition name="dropdown">
              ...
              >
                ...
                <a href="#" class="block px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20">退出登录</a>
              </div>
            </Transition>
          </Teleport>
        </div>
