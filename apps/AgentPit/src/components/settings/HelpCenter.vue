...
<template>
  <div class="help-center">
                ...
                <div v-if="expandedId === faq.id" class="px-4 pb-4 overflow-hidden">
                  <div class="pl-10 pr-2 pt-2 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex flex-wrap gap-1.5 mt-3 pt-2 border-t border-gray-100 dark:border-gray-700">
                      <span v-for="tag in faq.tags" :key="tag" class="px-2 py-0.5 text-xs bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full">{{ tag }}</span>
                    </div>
                  </div>
                </div>
              </Transition>
    ...
    <!-- 联系客服和快捷键 -->
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
      <div class="p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl">
        ...
        <div class="space-y-2 text-sm">
          <a href="#" class="flex items-center gap-2 text-green-700 dark:text-green-400 hover:underline">
            <span>💬</span> 在线聊天
          </a>
          <a href="#" class="flex items-center gap-2 text-green-700 dark:text-green-400 hover:underline">
      ...
      <div class="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl">
        ...
        <div class="space-y-1.5 text-xs">
          <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-400">全局搜索</span><kbd class="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-gray-700 dark:text-gray-300 font-mono">Ctrl+K</kbd></div>
          <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-400">切换侧边栏</span><kbd class="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-gray-700 dark:text-gray-300 font-mono">Ctrl+B</kbd></div>
          <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-400">保存内容</span><kbd class="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-gray-700 dark:text-gray-300 font-mono">Ctrl+S</kbd></div>
          <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-400">关闭弹窗</span><kbd class="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-gray-700 dark:text-gray-300 font-mono">Esc</kbd></div>
          <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-400">快捷键帮助</span><kbd class="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-gray-700 dark:text-gray-300 font-mono">Ctrl+/</kbd></div>
        </div>
      </div>
    </div>
...
<style scoped>
.faq-list-enter-active, .faq-list-leave-active { transition: all 0.3s ease; }
.faq-list-enter-from { opacity: 0; transform: translateY(-10px); }
.faq-list-leave-to { opacity: 0; transform: translateY(10px); }
...
.prose li::before { content: "• "; color: #6366f1; font-weight: bold; margin-right: 4px; }
.prose br + li::before { display: none; }
</style>
