...
describe('MeetingCalendar.vue', () => {
  it('应该渲染日历组件并显示当前月份', async () => {
    const MeetingCalendarModule = await import('../../src/components/lifestyle/MeetingCalendar.vue')
...
describe('TravelPlanner.vue', () => {
  it('应该渲染旅游规划器组件', async () => {
    const TravelPlannerModule = await import('../../src/components/lifestyle/TravelPlanner.vue')
...
describe('GameCenter.vue', () => {
  it('应该显示3个游戏选择卡片', async () => {
    const GameCenterModule = await import('../../src/components/lifestyle/GameCenter.vue')
...
describe('LifestyleDashboard.vue', () => {
  it('应该渲染生活服务总览面板', async () => {
    const DashboardModule = await import('../../src/components/lifestyle/LifestyleDashboard.vue')
    const wrapper = mount(DashboardModule.default)
    
    expect(wrapper.find('.lifestyle-dashboard').exists()).toBe(true)
    expect(wrapper.text()).toContain('今日会议数') || expect(wrapper.text()).toContain('待办事项提醒')
  })
...
describe('SnakeGame.vue', () => {
  it('应该渲染贪吃蛇游戏画布', async () => {
    const SnakeGameModule = await import('../../src/components/lifestyle/SnakeGame.vue')
...
describe('TetrisGame.vue', () => {
  it('应该渲染俄罗斯方块游戏画布', async () => {
    const TetrisGameModule = await import('../../src/components/lifestyle/TetrisGame.vue')
...
describe('Game2048.vue', () => {
  it('应该渲染2048游戏网格', async () => {
    const Game2048Module = await import('../../src/components/lifestyle/Game2048.vue')
