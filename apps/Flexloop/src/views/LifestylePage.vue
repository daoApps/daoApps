...
<template>
  <MainLayout>
    <div class="max-w-7xl mx-auto space-y-6">
      <!-- 页面标题 -->
      <div
        class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-2xl p-6 sm:p-8 text-white shadow-lg"
      >
        <h1 class="text-2xl sm:text-3xl font-bold">生活服务</h1>
        <p class="mt-2 text-indigo-100 max-w-xl">
          一站式生活管理工具，包含日历、旅行规划、休闲游戏等实用功能
        </p>
      ...
      <!-- 内容区域 -->
      <div
        class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden min-h-[500px]"
      >
