  ...
  <div class="space-y-6">
    ...
    <div class="relative flex justify-center items-center" style="height: 500px">
      <TransitionGroup name="card">
        ...
        >
          <div
            class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden h-[480px] relative"
          >
            <div
              class="h-3/4 bg-gradient-to-br from-pink-400 via-purple-500 to-indigo-600 relative overflow-hidden"
            >
              <img
                :src="user!.avatar"
                :alt="user!.name"
            ...
            <div class="p-6 pt-16">
              ...
              <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">
                {{ user!.location }} · {{ user!.online ? '在线' : '离线' }}
              </p>
      ...
      <Transition name="match">
        <div
          v-if="showMatchAnimation && matchedUser"
        ...
        >
          <div class="text-center space-y-6 animate-bounce">
            <div class="relative">
              ...
              />
              <div
                class="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-xl"
              >
            ...
            <div class="bg-white dark:bg-gray-800 px-8 py-4 rounded-2xl shadow-2xl">
              <h2
                class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500"
              >
                匹配成功！
              </h2>
    ...
    <div v-if="currentUser" class="flex justify-center gap-6 max-w-sm mx-auto">
      ...
      >
        <svg
          class="w-8 h-8 text-gray-600 dark:text-gray-400 group-hover:text-red-500 transition-colors"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      >
        <svg
          class="w-8 h-8 text-gray-600 dark:text-gray-400 group-hover:text-green-500 transition-colors"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
