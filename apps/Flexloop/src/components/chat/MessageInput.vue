...
<template>
  <div class="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4">
    <div class="max-w-4xl mx-auto">
      ...
      <!-- 输入区域 -->
      <div
        class="relative flex items-end gap-3 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-100 transition-all"
      >
        <textarea
          ref="textareaRef"
          :value="modelValue"
      ...
      <div class="flex justify-between items-center mt-2 px-1">
        <span class="text-xs text-gray-400"> 按 Enter 发送，Shift+Enter 换行 </span>
        <span
          :class="[
