...
<template>
  <div
    class="knowledge-graph__container bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden"
  >
    <!-- 工具栏 -->
    <div
    ...
    <!-- 图例 -->
    <div
      class="flex flex-wrap gap-4 px-4 py-3 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700"
    >
    ...
    >
      ...
      <!-- 缩放提示 -->
      <div
        class="absolute bottom-4 right-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg px-3 py-2 text-xs text-gray-600 dark:text-gray-400"
      >
              ...
              <div class="space-y-2">
                ...
                >
                  <span
                    ...
                    :style="{ backgroundColor: edgeTypeColors[edge.type] }"
                  ></span>
