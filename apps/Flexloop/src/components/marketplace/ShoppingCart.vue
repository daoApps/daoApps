  ...
  <div v-else class="max-w-6xl mx-auto space-y-6 pb-12">
    <div class="flex items-center justify-between">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">
        购物车 ({{ cartStore.items.length }})
      </h1>
      <button class="text-sm text-red-500 hover:text-red-600 font-medium" @click="handleClearCart">
        清空购物车
      </button>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 space-y-3">
        ...
        >
          <div
            class="bg-gray-50 dark:bg-gray-700/50 px-6 py-3 flex items-center gap-4 border-b border-gray-200 dark:border-gray-700"
          >
            ...
            >
              ...
              >
                ...
                <div class="min-w-0">
                  ...
                  <p
                    v-if="item.product.type !== 'digital' && item.product.type !== 'service'"
              ...
              <div class="w-20 text-center">
                <div class="flex flex-col items-center">
                  ...
                  <span v-if="item.product.originalPrice" class="text-xs text-gray-400 line-through"
      ...
      <div class="space-y-4">
        <div
          class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 sticky top-4"
        >
          ...
          <div class="space-y-3 text-sm">
            ...
            <div class="flex justify-between">
              ...
              <span
                :class="
                  cartStore.shippingCost === 0 ? 'text-green-600' : 'text-gray-900 dark:text-white'
                "
              >
            ...
            <div
              v-if="cartStore.subtotal > 0 && cartStore.subtotal < 299"
              class="text-xs text-orange-500 bg-orange-50 dark:bg-orange-900/20 px-3 py-2 rounded-lg"
            >
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-3 mt-3">
              <div class="flex justify-between items-baseline">
                ...
                <span class="text-2xl font-bold text-red-500"
                  >¥{{ cartStore.finalAmount.toLocaleString() }}</span
                >
              </div>
            </div>
          </div>
