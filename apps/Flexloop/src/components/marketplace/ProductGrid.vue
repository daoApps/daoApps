  ...
  <div v-else class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6">
    ...
    >
        ...
        <div class="absolute top-3 left-3 flex gap-1.5">
          <span
            ...
            :class="[
              ...
              tagConfig[tag]?.className || 'bg-gray-500 text-white'
            ]"
          >
      ...
      <div class="p-4">
        ...
        <h3
          class="font-semibold text-gray-900 dark:text-white mb-2 line-clamp-2 min-h-[48px] group-hover:text-primary-600 transition-colors"
        >
          {{ product.name }}
        </h3>

        <p class="text-xs text-gray-500 dark:text-gray-400 mb-3 line-clamp-1">
          已售 {{ product.salesCount.toLocaleString() }}
        </p>
