...
const myOrders = computed(() =>
  allOrders.filter((o) => o.items.some((i) => i.product.seller.id === sellerData.value.id))
);
...
const totalRevenue = computed(() => myOrders.value.reduce((sum, o) => sum + o.totalAmount, 0));
  ...
  <div class="max-w-7xl mx-auto space-y-6 pb-12">
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <div class="flex items-center gap-3 mt-1 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span
              v-if="sellerData.isVerified"
              class="px-2 py-0.5 bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 text-xs font-medium rounded-full flex items-center gap-1"
            >
      ...
      <div class="flex items-center gap-2">
        <button
          class="px-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center gap-1.5"
        >
    ...
    <div v-if="activeTab === 'overview'" class="space-y-6">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div class="flex items-start justify-between">
            ...
            <div
              class="w-12 h-12 rounded-xl flex items-center justify-center bg-green-100 dark:bg-green-900/30"
            >
        ...
        >
          <div class="flex items-start justify-between">
            ...
            <div
              class="w-12 h-12 rounded-xl flex items-center justify-center bg-blue-100 dark:bg-blue-900/30"
            >
              <span class="text-2xl">📦</span>
            </div>
          </div>
        ...
        >
          <div class="flex items-start justify-between">
            ...
            <div
              class="w-12 h-12 rounded-xl flex items-center justify-center bg-purple-100 dark:bg-purple-900/30"
            >
              <span class="text-2xl">🏪</span>
            </div>
          </div>
        ...
        >
          <div class="flex items-start justify-between">
            ...
            <div
              class="w-12 h-12 rounded-xl flex items-center justify-center bg-orange-100 dark:bg-orange-900/30"
            >
              <span class="text-2xl">👥</span>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div
          class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6"
        >
    ...
    <div v-if="activeTab === 'products'" class="space-y-4">
      <div class="flex items-center justify-between">
        <div class="flex gap-2">
          <button
            class="px-4 py-2 bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 rounded-lg text-sm font-medium"
          >
            全部 ({{ myProducts.length }})
          </button>
          <button
            class="px-4 py-2 text-gray-600 dark:text-gray-400 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700"
          >
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <div class="flex items-center gap-2">
            ...
            <button
              class="px-3 py-1.5 bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 rounded-lg text-xs font-medium hover:bg-primary-100 dark:hover:bg-primary-900/50 transition-colors"
            >
              编辑
            </button>
            <button
              class="px-3 py-1.5 bg-red-50 dark:bg-red-900/30 text-red-500 rounded-lg text-xs font-medium hover:bg-red-100 dark:hover:bg-red-900/50 transition-colors"
            >
              删除
            </button>
          </div>
    ...
    <div v-if="activeTab === 'orders'" class="space-y-4">
      ...
      >
        <div
          class="flex items-center justify-between mb-3 pb-3 border-b border-gray-100 dark:border-gray-700"
        >
      ...
      <form class="space-y-6 max-w-2xl" @submit.prevent="handlePublishSubmit">
        ...
        <div>
            ...
            <template v-for="i in 3" :key="i">
              ...
              >
                <template v-if="i <= publishFormData.images.length">
                  <img
                    :src="publishFormData.images[i - 1]"
                    alt=""
          ...
          <p class="text-xs text-gray-400 mt-2">
            最多上传5张图片，建议尺寸800x800，支持JPG/PNG格式
          </p>
        </div>
