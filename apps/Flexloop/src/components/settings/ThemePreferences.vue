  ...
  <div class="theme-preferences">
    ...
    <div class="space-y-8">
      ...
      <div>
        ...
        >
        <div
          class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-5 space-y-3"
        >
          <div class="flex items-center gap-2">
            <div
              class="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500"
            ></div>
            <div>
              <p
                class="font-medium text-gray-900 dark:text-white"
                :style="{
                  fontSize: fontSizes.find((f) => f.value === settings.fontSize)?.size || '16px'
                }"
              >
                示例用户名
              </p>
              <p
                ...
                :style="{
                  fontSize: `calc(${fontSizes.find((f) => f.value === settings.fontSize)?.size || '16px'} - 3px)`
                }"
              >
                user@example.com
              </p>
      ...
      <div>
        ...
        <div class="flex flex-wrap gap-3">
          ...
          <button
            ...
            @click="
              ...
              customColor && (settings.primaryColor = customColor);
            "
          >
            🎨
          </button>
        ...
        <input
          ...
          v-model="customColor"
          type="color"
          class="mt-2 w-12 h-8 rounded cursor-pointer"
          @input="(e: Event) => (settings.primaryColor = (e.target as HTMLInputElement).value)"
        />
      </div>
      ...
      <div class="space-y-4">
        ...
        >
          ...
          <button
            :class="[
              ...
              settings.reduceMotion ? 'bg-gray-300' : 'bg-indigo-500'
            ]"
          ...
          >
            <span
              :class="[
                ...
                settings.reduceMotion ? 'left-0.5' : 'left-[22px]'
              ]"
            ></span>
          </button>
        </div>
        ...
        >
          ...
          <button
            :class="[
              'relative w-12 h-7 rounded-full transition-colors',
              settings.highContrast ? 'bg-yellow-500' : 'bg-gray-300'
            ]"
          ...
          >
            <span
              :class="[
                'absolute top-0.5 w-6 h-6 bg-white rounded-full shadow transition-transform',
                settings.highContrast ? 'left-[22px]' : 'left-0.5'
              ]"
            ></span>
          </button>
        </div>
