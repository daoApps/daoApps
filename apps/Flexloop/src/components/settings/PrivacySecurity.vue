...
<template>
  <div class="privacy-security">
          ...
          >
            ...
            <svg v-else class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                ...
                stroke-linejoin="round"
                stroke-width="2"
                d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 010-2.222L3 9V6l3-3h3L12 3l3 3h3l3 3v3c0 .09-.003.179-.01.267A10.95 10.95 0 0113.875 18.825z"
              />
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
      ...
      <div>
        ...
        <div class="relative">
          <input
            ...
            placeholder="再次输入新密码"
            :class="[
              'w-full px-3 py-2.5 pr-10 rounded-lg border bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-400 outline-none',
          ...
          >
            ...
            <svg v-else class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                ...
                stroke-linejoin="round"
                stroke-width="2"
                d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7z"
              />
            </svg>
          </button>
        </div>
        <p v-if="!passwordsMatch && passwordForm.confirmPassword" class="text-xs mt-1 text-red-500">
          两次输入的密码不一致
        </p>
      </div>
    ...
    <div v-if="activeSection === 'twofa'" class="space-y-6">
      ...
      <!-- TOTP 设置流程 -->
      <div
        v-if="twoFactorEnabled && totpStep > 0"
      ...
      >
        ...
        <div v-if="totpStep === 1">
          ...
          <div class="flex justify-center my-4">
            <div
              class="w-48 h-48 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 rounded-xl flex items-center justify-center border-2 border-dashed border-gray-300 dark:border-gray-600"
            >
              <div class="text-center">
                ...
                >
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="1.5"
                    d="M12 4v1m6 11h2m-6 4h.01M19 12v1.5M3 12v1.5m0-9h2m6-4h.01M7 21h2m0 0h2m-6 0H5m4-8h4m-4 4h4"
                  />
                </svg>
          ...
          <button
            class="w-full mt-4 py-2.5 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 transition-colors font-medium"
            @click="totpStep = 2"
          >
            我已完成扫描 →
          </button>
        ...
        <div v-if="totpStep === 3">
          ...
          <!-- 备用码 -->
          <div
            class="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border border-yellow-200 dark:border-yellow-800"
          >
            ...
            <p class="text-xs text-yellow-600 dark:text-yellow-400 mb-3">
              请妥善保存以下备用码，每个码只能使用一次。当无法使用常规2FA方式时可用于登录。
            </p>
    ...
    <div v-if="activeSection === 'data'" class="space-y-6">
      ...
      <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
        <div
          class="p-4 bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-200 dark:border-red-800"
        >
          <h4 class="font-bold text-red-700 dark:text-red-400 mb-2">⚠️ 危险操作区域</h4>
          <p class="text-sm text-red-600 dark:text-red-400 mb-4">
            注销账户是永久性操作，删除后数据无法恢复！
          </p>
          <button
          ...
          <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-sm w-full p-6">
            <div class="text-center">
              ...
              <div class="flex gap-3">
                ...
                <button
                  class="flex-1 py-2.5 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors font-bold"
                  @click="deleteAccount"
                >
                  确认注销
                </button>
